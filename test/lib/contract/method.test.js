...
describe('#contract.method', function () {
    ...
    describe('#send()', function () {
        ...
        it("should revert if trying to set MN12GTFGMTbqyhRiYpDRyoVFd1Mxbtsn9N as the owner", async function () {
            this.timeout(30000)
            await assertThrow(testRevert.setOwner('MN12GTFGMTbqyhRiYpDRyoVFd1Mxbtsn9N').send({shouldPollResponse: true}),
                null,
                'REVERT'
            )
        });
